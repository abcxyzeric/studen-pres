...
Scene_Title.prototype.commandNewGame = function() {
    DataManager.setupNewGame();
    AudioManager.stopSe()
    AudioManager.playSe({"name":"title_rio_1","volume":100,"pitch":100,"pan":0});
...
Scene_Title.prototype.commandContinue = function() {
    AudioManager.stopSe()
    AudioManager.playSe({"name":"title_rio_2","volume":100,"pitch":100,"pan":0});
    this._commandWindow.close();
...
Scene_Title.prototype.commandOptions = function() {
    AudioManager.stopSe()
    AudioManager.playSe({"name":"title_rio_4","volume":65,"pitch":100,"pan":0});
    this._commandWindow.close();
