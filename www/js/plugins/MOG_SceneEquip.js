...
/*:ja
 * @plugindesc (v1.0) 要MOG_SceneMenu。装備シーンを装飾します。
 * @author Moghunter
 *
 * @param FontSize
 * @text フォントサイズ
...
Scene_Equip.prototype.create = function () {
	...
	this._commandWindow.y = Moghunter.scEquip_ComWindowY;
        this._commandWindow.width = 700
        this._commandWindow.height = 130;
	...
	this._itemWindow.width = 840;
	this._itemWindow.height = 270;
...
Window_EquipSlot.prototype.drawItem = function (index) {
	...
	if (this._actor) {
		...
		this.drawItemName(this._actor.equips()[index], rect.x + 138, rect.y + 2);
