...
function createBasicSymbols(){
    ...
    //unit_see戻し　ベーシックに変更すれば表示はされるが問題が起きそうなので一旦削除
//    const esacape = BasicSymbol.create("escape",param.basicEscape);
...
function createButtonLayoutChangeCommand(){
    const mText = new MultiLanguageText("Change button notation","Change button notation");
