 ...
 * https://makonet.sakura.ne.jp/rpg_tkool/Test/PictureLive2D/document.html
 * 
 * ------------------------------------------------------------------------------
...

{
    ...
    function load() {
        ...
        for (let file of $p['json file']) {
            let name = file.replace(/\.(?:json|model3.json)$/i, '');
...

{
    ...
    class Expression {
        constructor(expression) {
            ...
            this._fadeInTime = expression.Data.FadeInTime || 1;
            this._fadeOutTime = expression.Data.FadeOutTime || 1;
            this._parameters = [];
