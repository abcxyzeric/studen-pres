...
(function() {
    ...
    Game_Interpreter.prototype.refreshMapName = function(params) {
        ...
        if (params.text) {
            ...
            text = $gameMap.displayName() ? $gameMap.displayName() : '';
        }
        //------改変終了------
        //オリジナルコード↓
        ...
        if (params.picture) {
            ...
            bitmap.gradientFillRect(0, 0, bitmap.width / 3, bitmap.height, 'rgba(0,0,0,0)', params.color);
            bitmap.fillRect(bitmap.width / 3, 0, bitmap.width / 3, bitmap.height, params.color);
            bitmap.gradientFillRect((bitmap.width * 2) / 3, 0, bitmap.width / 3, bitmap.height, params.color, 'rgba(0,0,0,0)');
